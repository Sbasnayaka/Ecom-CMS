    ...
    <main class="main-content" style="padding-top: 0;">
        ...
        <div class="reviews-page-mobile d-lg-none">
            ...
            <div style="display: flex; justify-content: center; gap: 20px; margin-bottom: 50px;">
                <a href="#"><img src="<?= BASE_URL ?>assets/icons/facebook.png" style="width: 45px;"></a>
                <a href="#"><img src="<?= BASE_URL ?>assets/icons/tiktok.png" style="width: 45px;"></a>
                <a href="#"><img src="<?= BASE_URL ?>assets/icons/instagram.png" style="width: 45px;"></a>
                <a href="#"><img src="<?= BASE_URL ?>assets/icons/youtube.png" style="width: 45px;"></a>
                <a href="#"><img src="<?= BASE_URL ?>assets/icons/whatsapp.png" style="width: 45px;"></a>
            </div>
